function sta=e_sta_nombar_nochirp(fpath,fname,jnk,nt,lock_out,trg_period,stim_file)
%% sta
...
%trls=2;
       ...
       [PSTH_all, SPK_all]=single_cell_visualisze_nombar_nochirp(fpath,fname,jnk,stim_dur,bwid,i2);
